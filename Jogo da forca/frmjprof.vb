Public Class frmjprof
    ...
    Private Sub frmjprof_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub frmjprof_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        Randomize()
    End Sub
End Class